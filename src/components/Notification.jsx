...
export function Notification({ message, type = "info", onClose }) {
    ...
    return (
        <div className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg text-white ${bgColor} animate-fade-in-down`}>
            {icon}
