        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    onClick={async function () {
                        ...
                        // Fetch from Backend
                        try {
                            const response = await fetch(`http://localhost:3000/api/balance/eth/${wallet.address}`);
            ...
            <div className="grid gap-4">
                {addresses.map((p, index) => (
                    <div key={index} className="bg-slate-800/50 backdrop-blur-md border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 shadow-xl group">
