                ...
                <div className="flex flex-1 justify-end">
                    {!showImportInput ? (
                        <div className="flex gap-2">
                            ...
                            <button onClick={() => setShowImportInput(true)} className="bg-slate-800 hover:bg-slate-700 text-teal-400 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">
                                Import
                            </button>
                        </div>
                    ) : (
                        <div className="flex gap-1 w-full sm:max-w-sm">
                            ...
                            />
                            <button onClick={handleImportWallet} className="bg-teal-600 hover:bg-teal-500 text-white px-2 py-1.5 rounded-lg text-xs font-bold shrink-0">
                                Add
                            </button>
